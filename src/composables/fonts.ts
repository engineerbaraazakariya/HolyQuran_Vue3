export const fonts = [
  { value: "Arabic Regular", label: "العربي الافتراضي" },
  { value: "FS_Arabic Regular", label: "العربي الفصيح" },
  { value: "KFGQPC Uthman Taha Naskh", label: "عثمان طه نسخ" },
  { value: "Kamel_med", label: "الكامل الوسط" },
  { value: "MUHAMMADI_QURANIC_FONT", label: "المحمدي القرآني" },
  { value: "Nabi", label: "النبي" },
  { value: "Sada_Regular", label: "سدى الافتراضي" },
  { value: "Samim_Regular", label: "صميم الافتراضي" },
  { value: "UthmanTNB", label: "عثمان طه البارز" },
  { value: "UthmanTN", label: "عثمان طه النسخ" },
  { value: "mylotus_Regular", label: "اللوتس الافتراضي" },
];
